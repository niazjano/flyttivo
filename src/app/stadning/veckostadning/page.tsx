...
export const metadata: Metadata = {
  title: "Veckostädning i Kristianstad | Flyttivo",
  description:
    "Professionell veckostädning i Kristianstad. Vi kommer varje vecka och håller ditt hem rent och fräscht. Perfekt för familjer med barn. RUT-avdrag tillgängligt.",
};
        ...
        <div className="space-y-8">
          <header className="space-y-4">
            ...
            <p className="max-w-3xl text-base leading-relaxed text-slate-600">
              ...
              Kristianstad med omnejd där vi kommer varje vecka och gör en grundlig städning av
              ...
              närliggande orter. Med veckostädning får du regelbunden städning som
          ...
          <section className="rounded-2xl border-2 border-sky-600 bg-sky-50 p-8 text-center shadow-sm">
            <h2 className="mb-4 text-2xl font-semibold text-slate-900">
              Boka veckostädning i Kristianstad
            </h2>
