...
export const metadata: Metadata = {
  title: "Flyttfirma Hässleholm – Flytthjälp & bohagsflytt | Flyttivo",
  description:
    "Flyttivo är en lokal flyttfirma i Hässleholm. Vi hjälper med trygg flytthjälp, bohagsflytt och flyttstädning i Hässleholm, Kristianstad, Osby och omnejd. RUT-avdrag ingår.",
};

export default function FlyttfirmaHassleholmPage() {
  return (
    <div className="space-y-10">
          <header className="space-y-4">
            <h1 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
              Flyttfirma i Hässleholm – trygg & prisvärd flytthjälp
            </h1>
            <div className="space-y-3 text-base leading-relaxed text-slate-600">
              <p>
                Flyttivo är en lokal flyttfirma med stark närvaro i Hässleholm.
                Vi hjälper privatpersoner och företag med trygg bohagsflytt,
                bärhjälp och transport. Oavsett om du flyttar från lägenhet,
                villa eller kontor i Hässleholm, så tar vi hand om hela flytten
                från början till slut.
              </p>
              <p>
                Vi är också aktiva i närliggande orter som Kristianstad, Osby,
                Östra Göinge, Broby, Hanaskog, Knislinge och Sibbhult. Som
                privatperson kan du använda RUT-avdrag på upp till 50% av
                arbetskostnaden vid flyttjänster – vi sköter avdraget direkt på
                fakturan.
              </p>
            </div>
          </header>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              Flytthjälp i Hässleholm
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                Vi erbjuder komplett flytthjälp i Hässleholm med erfaren personal
                och rätt utrustning. Våra flyttkillar är försäkrade och arbetar
                strukturerat för att säkerställa att dina tillhörigheter kommer
                fram i samma skick som de lämnade.
              </p>
            </div>
              ...
              <ul className="space-y-2 text-base text-slate-600">
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    Vi känner Hässleholm väl och planerar effektiva rutter och
                    tidsplaner.
                  </span>
                </li>
              </ul>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 text-base text-slate-600">
              <p>
                Många kunder i Hässleholm väljer att kombinera flytt med
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="mb-4 text-xl font-semibold text-slate-900">
              Boka flyttfirma i Hässleholm
            </h2>
            <p className="mb-4 text-base text-slate-600">
              Kontakta oss för en kostnadsfri offert på din flytt i Hässleholm
