      ...
      <section className="reveal bg-slate-50 py-16 sm:py-20" data-reveal data-reveal-id="services">
        <div className="mx-auto max-w-6xl px-4 space-y-8 md:px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {/* Flytt Service Card */}
            <Card href="/flyttfirma" className="transition-all duration-300 ease-out hover:shadow-md">
            ...
            <Card href="/stadning" className="transition-all duration-300 ease-out hover:shadow-md">
              <div className="flex h-full flex-col p-6 sm:p-7">
                <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-sky-50 text-sky-700">
                  <svg
                    viewBox="0 0 24 24"
            ...
            {/* Trygg Partner Card */}
            <Card href="/trygg-partner" className="transition-all duration-300 ease-out hover:shadow-md">
              <div className="flex h-full flex-col p-6 sm:p-7">
                <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-sky-50 text-sky-700">
                  <svg
                    viewBox="0 0 24 24"
