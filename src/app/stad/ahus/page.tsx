...
export const metadata: Metadata = {
  title: "Flytt & städ i Åhus – Flyttivo | Flyttfirma & Städfirma",
  description:
    "Flyttivo är din lokala flyttfirma och städfirma i Åhus. Vi erbjuder trygg flytthjälp, flyttstädning och hemstädning i Åhus och omnejd. RUT-avdrag ingår.",
};

export default function StadAhusPage() {
  return (
      ...
      <div className="space-y-10">
        <header className="space-y-4">
          ...
          <div className="space-y-3 text-base leading-relaxed text-slate-600">
            <p>
              Flyttivo är din lokala flyttfirma och städfirma i Åhus. Vi hjälper
              privatpersoner och företag med trygg flytt, flyttstädning och
              återkommande städning i Åhus och omnejd. Med Flyttivo får du en
              helhetslösning för både flytt och städning – allt från första
              kartong till sista städrond.
            </p>
            <p>
              Vi är aktiva i Åhus och närliggande orter som Kristianstad,
        ...
        <section className="space-y-4">
          ...
          <p className="text-base leading-relaxed text-slate-600">
            Flyttivo erbjuder komplett flytthjälp i Åhus. Vi hjälper med
        ...
        <section className="space-y-4">
          ...
          <p className="text-base leading-relaxed text-slate-600">
            ...
            Åhus. Våra städare arbetar strukturerat med checklistor och
            ...
            återkommande hemstädning för din bostad eller sommarstuga, så hjälper
            vi dig.
          </p>
          <Link
            href="/stadning"
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          <h2 className="mb-4 text-xl font-semibold text-slate-900">
            Boka flytt eller städning i Åhus
          </h2>
          <p className="mb-6 text-base text-slate-600">
            Kontakta oss för en kostnadsfri offert på flytt eller städning i Åhus
