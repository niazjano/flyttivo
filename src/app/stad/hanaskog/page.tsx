...
export const metadata: Metadata = {
  title: "Flytt & städ i Hanaskog – Flyttivo | Flyttfirma & Städfirma",
  description:
    "Flyttivo är din lokala flyttfirma och städfirma i Hanaskog. Vi erbjuder trygg flytthjälp, flyttstädning och hemstädning i Hanaskog och omnejd. RUT-avdrag ingår.",
};

export default function StadHanaskogPage() {
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-20 md:px-6">
      <div className="space-y-10">
        <header className="space-y-4">
          <h1 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
            Flytt & städ i Hanaskog
          </h1>
          <div className="space-y-3 text-base leading-relaxed text-slate-600">
            <p>
              Flyttivo är din lokala flyttfirma och städfirma i Hanaskog. Vi
              hjälper privatpersoner och företag med trygg flytt, flyttstädning
              och återkommande städning i Hanaskog och omnejd. Med Flyttivo får du
              en helhetslösning för både flytt och städning – allt från första
              kartong till sista städrond.
            </p>
            <p>
              Vi är aktiva i Hanaskog och närliggande orter som Kristianstad,
              Hässleholm, Östra Göinge, Broby, Knislinge, Sibbhult och Glimåkra.
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-slate-900">
            Flyttfirma i Hanaskog
          </h2>
          <p className="text-base leading-relaxed text-slate-600">
            Flyttivo erbjuder komplett flytthjälp i Hanaskog. Vi hjälper med
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-slate-900">
            Städfirma i Hanaskog
          </h2>
          <p className="text-base leading-relaxed text-slate-600">
            Vi erbjuder noggrann flyttstädning, hemstädning och veckostädning i
            Hanaskog. Våra städare arbetar strukturerat med checklistor och
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          <h2 className="mb-4 text-xl font-semibold text-slate-900">
            Boka flytt eller städning i Hanaskog
          </h2>
          <p className="mb-6 text-base text-slate-600">
            Kontakta oss för en kostnadsfri offert på flytt eller städning i
            Hanaskog och omnejd. Vi återkommer oftast samma dag med ett tydligt
            prisförslag.
          </p>
