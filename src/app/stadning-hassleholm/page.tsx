...
export const metadata: Metadata = {
  title: "Städfirma Hässleholm – Flyttstädning & hemstädning | Flyttivo",
  description:
    "Flyttivo är en lokal städfirma i Hässleholm. Vi erbjuder flyttstädning, hemstädning och veckostädning i Hässleholm, Kristianstad, Osby och omnejd. RUT-avdrag ingår.",
};

export default function StadningHassleholmPage() {
  return (
    <div className="space-y-10">
          <header className="space-y-4">
            <h1 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
              Städfirma i Hässleholm – flyttstädning & hemstädning
            </h1>
            <div className="space-y-3 text-base leading-relaxed text-slate-600">
              <p>
                Flyttivo är din lokala städpartner i Hässleholm. Vi hjälper
              ...
              <p>
                Vi är aktiva i Hässleholm och omnejd, inklusive Kristianstad,
                Osby, Östra Göinge, Broby, Hanaskog, Knislinge och Sibbhult.
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 text-base text-slate-600">
              <p>
                När du säljer eller lämnar en bostad i Hässleholm krävs ofta en
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              Hemstädning & veckostädning i Hässleholm
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                För många familjer i Hässleholm blir regelbunden hemstädning en
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              RUT-avdrag på städning i Hässleholm
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                Som privatperson kan du använda RUT-avdrag på upp till 50% av
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="mb-4 text-xl font-semibold text-slate-900">
              Boka städhjälp i Hässleholm
            </h2>
            <p className="mb-4 text-base text-slate-600">
              Kontakta oss för en kostnadsfri offert på städning i Hässleholm
