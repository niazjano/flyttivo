...
export const metadata: Metadata = {
  title: "Städfirma Knislinge – Flyttstädning & hemstädning | Flyttivo",
  description:
    "Flyttivo är en lokal städfirma i Knislinge. Vi erbjuder flyttstädning, hemstädning och veckostädning i Knislinge, Kristianstad, Östra Göinge och omnejd. RUT-avdrag ingår.",
};

export default function StadningKnislingePage() {
  return (
    <div className="space-y-10">
          <header className="space-y-4">
            <h1 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
              Städfirma i Knislinge – flyttstädning & hemstädning
            </h1>
            <div className="space-y-3 text-base leading-relaxed text-slate-600">
              <p>
                Flyttivo är din lokala städpartner i Knislinge. Vi hjälper
                privatpersoner och företag med noggrann flyttstädning,
                återkommande hemstädning och veckostädning. Vårt mål är att ge
                dig ett skinande rent hem utan att du behöver tänka på det.
              </p>
              <p>
                Vi är aktiva i Knislinge och omnejd, inklusive Kristianstad,
                Östra Göinge, Broby, Hanaskog, Sibbhult, Glimåkra och
                Hässleholm. Som privatperson kan du använda RUT-avdrag på upp
                till 50% av arbetskostnaden för städning – vi hanterar avdraget
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 text-base text-slate-600">
              <p>
                När du säljer eller lämnar en bostad i Knislinge krävs ofta en
                grundlig flyttstädning. Vi följer mäklarnas riktlinjer och
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              Hemstädning & veckostädning i Knislinge
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                För många familjer i Knislinge blir regelbunden hemstädning en
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              RUT-avdrag på städning i Knislinge
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="mb-4 text-xl font-semibold text-slate-900">
              Boka städhjälp i Knislinge
            </h2>
            <p className="mb-4 text-base text-slate-600">
              Kontakta oss för en kostnadsfri offert på städning i Knislinge
