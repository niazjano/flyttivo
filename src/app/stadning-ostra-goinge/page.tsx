...
export const metadata: Metadata = {
  title: "Städfirma Östra Göinge – Flyttstädning & hemstädning | Flyttivo",
  description:
    "Flyttivo är en lokal städfirma i Östra Göinge. Vi erbjuder flyttstädning, hemstädning och veckostädning i Östra Göinge, Kristianstad, Hässleholm och omnejd. RUT-avdrag ingår.",
};

export default function StadningOstraGoingePage() {
  return (
    <div className="space-y-10">
          <header className="space-y-4">
            <h1 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
              Städfirma i Östra Göinge – flyttstädning & hemstädning
            </h1>
            <div className="space-y-3 text-base leading-relaxed text-slate-600">
              <p>
                Flyttivo är din lokala städpartner i Östra Göinge. Vi hjälper
              ...
              <p>
                Vi är aktiva i Östra Göinge och omnejd, inklusive Kristianstad,
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 text-base text-slate-600">
              <p>
                När du säljer eller lämnar en bostad i Östra Göinge krävs ofta
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              Hemstädning & veckostädning i Östra Göinge
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                För många familjer i Östra Göinge blir regelbunden hemstädning
                en viktig del av vardagen. Vi anpassar städningen efter dina
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              RUT-avdrag på städning i Östra Göinge
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                Som privatperson kan du använda RUT-avdrag på upp till 50% av
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="mb-4 text-xl font-semibold text-slate-900">
              Boka städhjälp i Östra Göinge
            </h2>
            <p className="mb-4 text-base text-slate-600">
              Kontakta oss för en kostnadsfri offert på städning i Östra
