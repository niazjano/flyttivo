...
export const metadata: Metadata = {
  title: "Flyttfirma Knislinge – Flytthjälp & bohagsflytt | Flyttivo",
  description:
    "Flyttivo är en lokal flyttfirma i Knislinge. Vi hjälper med trygg flytthjälp, bohagsflytt och flyttstädning i Knislinge, Kristianstad, Östra Göinge och omnejd. RUT-avdrag ingår.",
};

export default function FlyttfirmaKnislingePage() {
  return (
    <div className="space-y-10">
          <header className="space-y-4">
            <h1 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
              Flyttfirma i Knislinge – trygg & prisvärd flytthjälp
            </h1>
            <div className="space-y-3 text-base leading-relaxed text-slate-600">
              <p>
                Flyttivo är en lokal flyttfirma med stark närvaro i Knislinge.
                Vi hjälper privatpersoner och företag med trygg bohagsflytt,
                bärhjälp och transport. Oavsett om du flyttar från lägenhet,
                villa eller gård i Knislinge, så tar vi hand om hela flytten från
                början till slut.
              </p>
              <p>
                Vi är också aktiva i närliggande orter som Kristianstad, Östra
                Göinge, Broby, Hanaskog, Sibbhult, Glimåkra och Hässleholm.
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              Flytthjälp i Knislinge
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                Vi erbjuder komplett flytthjälp i Knislinge med erfaren personal
                som känner området. Våra flyttkillar är försäkrade och arbetar
              ...
              <ul className="space-y-2 text-base text-slate-600">
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    Vi känner Knislinge väl och planerar effektiva rutter.
                  </span>
                </li>
              </ul>
            </div>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              Flyttstädning i Knislinge
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                Många kunder i Knislinge väljer att kombinera flytt med
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="mb-4 text-xl font-semibold text-slate-900">
              Boka flyttfirma i Knislinge
            </h2>
            <p className="mb-4 text-base text-slate-600">
              Kontakta oss för en kostnadsfri offert på din flytt i Knislinge
