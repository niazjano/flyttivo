...
export const metadata: Metadata = {
  title: "Städfirma Åhus – Flyttstädning & hemstädning | Flyttivo",
  description:
    "Flyttivo är en lokal städfirma i Åhus. Vi erbjuder flyttstädning, hemstädning och veckostädning i Åhus, Kristianstad, Sölvesborg och omnejd. RUT-avdrag ingår.",
};

export default function StadningAhusPage() {
  return (
    <div className="space-y-10">
          <header className="space-y-4">
            <h1 className="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
              Städfirma i Åhus – flyttstädning & hemstädning
            </h1>
            <div className="space-y-3 text-base leading-relaxed text-slate-600">
              <p>
                Flyttivo är din lokala städpartner i Åhus. Vi hjälper
                privatpersoner och företag med noggrann flyttstädning,
                återkommande hemstädning och veckostädning. Vårt mål är att ge
                dig ett skinande rent hem eller sommarstuga utan att du behöver
                tänka på det.
              </p>
              <p>
                Vi är aktiva i Åhus och omnejd, inklusive Kristianstad,
                Sölvesborg, Bromölla och längs kusten. Som privatperson kan du
                använda RUT-avdrag på upp till 50% av arbetskostnaden för
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3 text-base text-slate-600">
              <p>
                När du säljer eller lämnar en bostad i Åhus krävs ofta en
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-900">
              Hemstädning & veckostädning i Åhus
            </h2>
            <div className="space-y-3 text-base text-slate-600">
              <p>
                För många familjer i Åhus blir regelbunden hemstädning en
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="mb-4 text-xl font-semibold text-slate-900">
              Boka städhjälp i Åhus
            </h2>
            <p className="mb-4 text-base text-slate-600">
              Kontakta oss för en kostnadsfri offert på städning i Åhus eller
